    ...
    <div class="container mt-3">
        <div class="row">
            <div class="col">
                ...
                <p class="fst-italic">Please find below the contact details</p>
            </div>
        </div>
    </div>
...
<div v-if="!loading && errorMessage">
    <div class="container mt-3">
        <div class="row">
            <div class="col">
                <p class="h4 text-danger fw-bold">{{ error.Message }}</p>
            </div>
        </div>
    </div>
</div>
          ...
          <img :src="contact.photo" alt="" class="contact-img-big">
            ...
            <div class="col-md-6">
                <ul class="list-group">
                    ...
                    <li class="list-group-item">Title : <span class="fw-bold"></span>{{ contact.title }}</li>
